...
const EmailParser_1 = require("../parsers/EmailParser");
class EmailAdapter extends SourceAdapter_1.BaseSourceAdapter {
    constructor(sourceType = "Gmail") {
    ...
    async fetchCommunications() {
        ...
        for (const rawEmail of this.mockData) {
            try {
                ...
                let project;
                if ((_a = parsedEmail.subject) === null || _a === void 0 ? void 0 : _a.includes("Mortgage")) {
                    project = "Home Purchase";
                }
                else if ((_b = parsedEmail.subject) === null || _b === void 0 ? void 0 : _b.includes("Interview")) {
                ...
                // Extract dimensions
                const dimensions = this.dimensionExtractor.extractDimensions(parsedEmail);
